                ...
                <div className="flex flex-col p-5 max-[610px]:p-0 gap-2">
                    ...
                    <div className="flex max-[610px]:flex-col gap-4">
                        <div className={`${backCampoClass} w-1/2 max-[610px]:w-full`}>
                            <label className={`${titleClass}`}>CPF se tiver em mãos a nova Carteira de Identidade:</label>
                            <input
                                name="cpf"
                                maxLength={14}
                        ...
                        <div className={`${backCampoClass} w-1/2 max-[610px]:w-full`}>
                            <label className={`${titleClass}`}>RG caso sua Identidade ainda seja a Antiga:</label>
                            <input
                                name="rg"
                                maxLength={14}
...
export const VisualizarPedidoAntCivil = () => {
