        ...
        <div className="w-full">
            <form onSubmit={handleSubmit} id="submit" action="post" className="flex flex-col mt-5 gap-2">
                <div className="flex flex-col p-5 max-[610px]:p-0 mb-5 gap-2">
                    ...
                    <div className={`${backCampoClass}`}>
                        <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span> Estado Civil:</label>
                        <input
                            required
                            name="estado_civil"
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-3 max-[610px]:flex-col">
                            <div className={`${backCampoClass} w-2/3 max-[610px]:w-full `}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span> Endereço:</label>
                                <input
                                    required
                    ...
                    <div className={`${backCampoClass}`}>
                        <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span> Telefones:</label>
                ...
                <div className="flex flex-col p-5 max-[610px]:p-0 mb-5 gap-2">
                    ...
                    <div className={`${backCampoClass}`}>
                        <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span> Escolaridade:</label>
