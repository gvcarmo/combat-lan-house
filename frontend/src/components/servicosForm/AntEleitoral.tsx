            ...
            <form onSubmit={handleSubmit} id="submit" className="flex flex-col mt-5 gap-2">
                ...
                <div className="flex flex-col p-5 max-[610px]:p-0 gap-2">
                    ...
                    <div className={`${backCampoClass}`}>
                        <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Nome Completo do Eleitor:</label>
                        <input
                            required
                            name="nome_completo"
                    ...
                    <div className="flex max-[610px]:flex-col gap-4">
                        <div className={`${backCampoClass} w-1/2 max-[610px]:w-full`}>
                            <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Número do Título Eleitoral ou CPF</label>
                            <input
                                name="cpf_ou_titulo"
                                className={`${campoClass}`}
                    ...
                    <div>
                        <div className={`${backCampoClass} max-[610px]:w-full w-1/2`}>
                            <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Opção de filiação (conforme o cadastro na Justiça Eleitoral):</label>
                            <select
                                required
                                name="filiacao"
                                className={`${campoClass}`}
