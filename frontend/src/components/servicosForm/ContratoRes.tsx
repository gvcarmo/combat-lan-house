            ...
            <form onSubmit={handleSubmit} id="submit" className="flex flex-col mt-5 gap-2">
                ...
                <div className="flex flex-col p-5 max-[610px]:p-0 gap-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex max-[1139px]:flex-col gap-4">
                            <div className={`${backCampoClass} w-1/2 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Nome completo do Locador:</label>
                                <input
                                    required
                            ...
                            <div className={`${backCampoClass} w-1/2 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  CPF do Locador:</label>
                                <input
                                    required
                                    name="cpf_locador"
                                    maxLength={14}
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-3 max-[610px]:flex-col">
                                <div className={`${backCampoClass} w-2/3 max-[610px]:w-full `}>
                                    <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Rua do Locador:</label>
                                    <input
                                        required
                            ...
                            <div className="flex gap-3 max-[610px]:flex-col">
                                <div className={`${backCampoClass} w-1/3 max-[610px]:w-full `}>
                                    <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Bairro:</label>
                                    <input
                                        required
                                ...
                                <div className={`${backCampoClass} w-2/3 max-[610px]:w-full`}>
                                    <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Cidade / Estado:</label>
                                    <input
                                        required
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex max-[1139px]:flex-col gap-4">
                            <div className={`${backCampoClass} w-1/2 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Nome completo do Locatário:</label>
                                <input
                                    required
                            ...
                            <div className={`${backCampoClass} w-1/2 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  CPF do Locatário:</label>
                                <input
                                    required
                                    name="cpf_locatario"
                                    maxLength={14}
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-3 max-[610px]:flex-col">
                                <div className={`${backCampoClass} w-2/3 max-[610px]:w-full `}>
                                    <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Rua do Imóvel:</label>
                                    <input
                                        required
                                        placeholder="Ex.: Rua Dr. Adilson Resende Facure"
                                        className={`${campoClass}`}
                        ...
                        <div className="flex max-[1139px]:flex-col gap-4">
                            <div className={`${backCampoClass} w-1/3 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Prazo de locação:</label>
                                <input
                                    required
                                    name="prazo_locacao"
                            ...
                            <div className={`${backCampoClass} w-1/3 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Data de início da Locação:</label>
                                <input
                                    required
                            ...
                            <div className={`${backCampoClass} w-1/3 max-[1139px]:w-full`}>
                                <label className={`${titleClass}`}><span className="text-[16px] text-red-500">*</span>  Valor do Aluguel:</label>
                                <input
                                    required
                                    name="valor_aluguel"
