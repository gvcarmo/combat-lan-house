            ...
            <form onSubmit={handleSubmit} id="submit" className="flex flex-col mt-5 gap-2">
                ...
                <div className="flex flex-col p-5 max-[610px]:p-0 gap-2">
                    ...
                    <div className={`${backCampoClass}`}>
                        <label className={`${titleClass}`}>Nome Completo do Microempreendedor: *</label>
                        <input
                            required
                            name="nome_completo"
                    ...
                    <div className="flex max-[610px]:flex-col gap-4">
                        <div className={`${backCampoClass} w-1/2 max-[610px]:w-full`}>
                            <label className={`${titleClass}`}>Número do CNPJ: *</label>
                            <input
                                required
                                name="numero_mei"
                                maxLength={14}
                        ...
                        <div className={`${backCampoClass} w-1/2 max-[610px]:w-full`}>
                            <label className={`${titleClass}`}>Ano / Mês: *</label>
                            <input
                                required
                                name="ano_mes"
                                maxLength={14}
...
export const VisualizarPedidoMEI = () => {
